...
type AddTaskRequest struct {
	...
	RecurringTaskID int64  `protobuf:"varint,2,opt,name=RecurringTaskID,proto3" json:"RecurringTaskID,omitempty"` // Recurring Task ID:
...
func (x *AddTaskRequest) GetRecurringTaskID() int64 {
	if x != nil {
...
var file_engine_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x54, 0x61, 0x73, 0x6b, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,

...
type StartTaskRequest struct {
	...
	Interval uint64 `protobuf:"varint,5,opt,name=interval,proto3" json:"interval,omitempty"` //in minute
	Count    uint64 `protobuf:"varint,6,opt,name=count,proto3" json:"count,omitempty"`       //0 ~ infinitive
}
...
func (x *StartTaskRequest) GetTime() uint64 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *StartTaskRequest) GetInterval() uint64 {
	if x != nil {
		return x.Interval
	}
	return 0
...
func (x *StartTaskRequest) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_scheduler_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x18, 0x03,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x23, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x61,
	0x73, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x22, 0x21, 0x0a, 0x0f, 0x53, 0x74,
	0x6f, 0x70, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x42, 0x2c, 0x0a,

...
func (x *ServiceTag) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServiceTag) ProtoMessage() {}

func (x *ServiceTag) ProtoReflect() protoreflect.Message {
	mi := &file_scyna_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServiceTag.ProtoReflect.Descriptor instead.
func (*ServiceTag) Descriptor() ([]byte, []int) {
	return file_scyna_proto_rawDescGZIP(), []int{3}
}

func (x *ServiceTag) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ServiceTag) GetRequest() string {
	if x != nil {
		return x.Request
	}
	return ""
...
func (x *ServiceTag) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
var file_scyna_proto_rawDesc = []byte{
	...
	0x07, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x22, 0x53, 0x0a, 0x0d, 0x45, 0x76, 0x65, 0x6e,
	...
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0x5a, 0x0a,
	0x0a, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x61, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x02,
	...
	0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1d, 0x0a, 0x0e, 0x69, 0x6f, 0x2e,
...
var file_scyna_proto_goTypes = []interface{}{
	...
	(*ServiceTag)(nil),    // 3: scyna.ServiceTag
}

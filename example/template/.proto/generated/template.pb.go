...
func (x *CreateNameRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_template_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x27, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
...
var file_template_proto_goTypes = []interface{}{
	(*CreateNameRequest)(nil), // 0: proto.CreateNameRequest
}

...
type SetupModuleDatabaseRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SetupModuleDatabaseRequest) Reset() {
	*x = SetupModuleDatabaseRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetupModuleDatabaseRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetupModuleDatabaseRequest) ProtoMessage() {}

func (x *SetupModuleDatabaseRequest) ProtoReflect() protoreflect.Message {
	mi := &file_module_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetupModuleDatabaseRequest.ProtoReflect.Descriptor instead.
func (*SetupModuleDatabaseRequest) Descriptor() ([]byte, []int) {
	return file_module_proto_rawDescGZIP(), []int{1}
}

func (x *SetupModuleDatabaseRequest) GetModule() string {
	if x != nil {
		return x.Module
	}
	return ""
...
var file_module_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x34, 0x0a, 0x1a, 0x53, 0x65, 0x74, 0x75, 0x70, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65,
	...
	0x06, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x42, 0x0c, 0x48, 0x02, 0x5a, 0x08, 0x2e, 0x2f, 0x3b,
...
var file_module_proto_goTypes = []interface{}{
	...
	(*SetupModuleDatabaseRequest)(nil), // 1: proto.SetupModuleDatabaseRequest
}
...
func file_module_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_module_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetupModuleDatabaseRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
